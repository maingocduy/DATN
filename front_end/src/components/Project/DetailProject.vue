...
import Member from '../DetailProjectCompo/MemberInProject.vue'
import project from '../DetailProjectCompo/detail.vue'
import sponsor from '../DetailProjectCompo/sponsorInProject.vue'
